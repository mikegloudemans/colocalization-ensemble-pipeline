...
class TestLocus:
    ...
    def run(self):
        ...
        if self.settings["plot_only"] != True:
        ...
        if (plotworthy or self.settings["plot_all"] == True or self.settings["plot_only"] == True) and ("plot_none" not in self.settings or self.settings["plot_none"] != True):
