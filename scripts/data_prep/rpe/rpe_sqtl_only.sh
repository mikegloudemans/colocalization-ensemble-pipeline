...
tabix -f -S 1 -s 2 -b 3 -e 3 $sqtl_dir/rpe_glucose_sqtls.txt.gz
...
bgzip -f $sqtl_dir/rpe_galactose_sqtls.txt
tabix -f -S 1 -s 2 -b 3 -e 3 $sqtl_dir/rpe_galactose_sqtls.txt.gz
