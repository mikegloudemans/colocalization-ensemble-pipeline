...
def run_fastqtl(gene, covariates, tissue_prefix, gwas_suffix, gwas_chrom, gwas_pos, conditional_level, replace_existing = False):
	...
	subprocess.call("rm /users/mgloud/projects/brain_gwas/tmp/fastQTL/{0}/{1}_{2}/{3}/{4}_expression.bed.gz 2> /dev/null".format(gwas_suffix.replace(".", "_"), gwas_chrom, gwas_pos, tissue_prefix, gene), shell=True)
