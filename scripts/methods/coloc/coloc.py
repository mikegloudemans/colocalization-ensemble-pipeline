...
def main():
	...
	coloc_status = subprocess.run(f"Rscript ../scripts/methods/coloc/run_coloc.R {in_file} {N_trait1} {s_trait1} {type_trait1} {N_trait2} {s_trait2} {type_trait2}".split(), capture_output=True)
