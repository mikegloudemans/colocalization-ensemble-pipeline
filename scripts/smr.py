...
def run_smr(locus):
    ...
    ## create esd
    esd = pd.DataFrame({'Chr': dat.chr_eqtl, 'SNP': dat.rsid_eqtl, 'Bp': dat.snp_pos, 'A1': dat.alt_eqtl, 'A2': dat.ref_eqtl, 'Freq': dat.effect_af_eqtl, 'Beta': dat.beta_eqtl, 'se': dat.se_eqtl, 'p': dat.pvalue_eqtl})
    ...
    dat['n'] = n
    gwas = dat[['rsid_gwas','alt_gwas','ref_gwas','effect_af_gwas','beta_gwas','se_gwas','pvalue_gwas','n']]
